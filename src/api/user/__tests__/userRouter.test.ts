...
//       expect(responseBody.content.length).toEqual(users.length);
//       responseBody.content.forEach((user, index) => compareUsers(users[index] as User, user));
//     });
//   });
...
//       compareUsers(expectedUser, responseBody.content);
//     });
...
//       expect(responseBody.content).toBeNull();
//     });
